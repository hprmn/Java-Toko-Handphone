...
public class backupView extends javax.swing.JFrame {
    ...
    private void browseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browseActionPerformed
        ...
        choose.setSelectedFile(new File("namabackup"));
    ...
    private void BackupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackupActionPerformed
        ...
        if (backup.getText().isEmpty()) {
            ...
            try {
                ...
                p = r.exec("./bin/mysqldump.exe -h" + host + " -u " + username + " -p" + password + " -P" + port + " --add-drop-database -B " + database + " -r" + path);
                int pComplete = p.waitFor();
                if (pComplete == 0) {
                    System.out.println("Backup Berhasil");
